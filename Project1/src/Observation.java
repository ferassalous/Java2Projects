/** 
 * Class that represents Data held in a File of type mdf
 * Stores a single measurement and flags it if its bad
 * @author Feras Salous 
 * Also Collaborated with TA's and Nahall Mansouri
 * @version 2018-09-12
 * Lab Section 13
 *
 */
public class Observation 
{
	...
	/**
	 * Constructor, that takes in a Double Value and a String value and analyzes
	...
	/**
	 * Verifies that the Value which was placed in the Observation Constructor is Valid
	...
	/**
	 * Formats a String in this format: Double Value C At Station id
	 * Example: 36.5 C at HOOK
